...
CKPT_PATH="/home/jovyan/SATD_Identification/CARP-Sun-2023/outputs/trained_models/sst2_roberta_large/epoch5_bs16_lr1e-5_weightdecay0.05_warmup0.06_maxlen200_dropout0.2_grad2/checkpoint/epoch=1-val_loss=0.1233-val_acc=0.9644.ckpt"
CANDI_TYPE=train
THRESHOLD=0.0
TOPK=24
